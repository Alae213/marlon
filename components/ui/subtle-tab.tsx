    ...
    return (
      ...
      >
        <div
          ...
          {...props}
        >
          {/* Selected pill - customized to match design system */}
          {selectedRect && (
            <motion.div
              className="absolute rounded-full bg-[var(--system-100)] pointer-events-none"
              initial={false}
              animate={{
          ...
          {/* Hover pill - customized to match design system */}
          <AnimatePresence>
            {hoverRect && !isHoveringSelected && selectedRect && (
              <motion.div
                className="absolute rounded-full bg-[var(--system-200)]/60 pointer-events-none"
                initial={{
                  left: selectedRect.left,
                  width: selectedRect.width,
                  top: selectedRect.top,
          ...
          {/* Focus ring - customized with blue-300 */}
          <AnimatePresence>
            {focusRect && (
              <motion.div
                className="absolute rounded-full pointer-events-none z-20 border border-[var(--blue-300)]"
                initial={false}
                animate={{
      ...
      >
        <Icon
          ...
          className={cn(
            ...
            isActive ? "text-[var(--system-600)]" : "text-[var(--system-400)]"
          )}
        />
