          ...
          <AnimatePresence>
            {activeRect && (
              <motion.div
                ...
                className="absolute bg-accent/40 pointer-events-none rounded-[16px]"
                initial={{
                  opacity: 0,
                  top: activeRect.top,
    ...
    return (
      <tr
        ...
        className={cn(
          ...
          hideBorder ? "border-transparent" : "border-[var(--system-200)]",
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-3 py-2 text-left text-[var(--system-600)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2 text-[var(--system-500)] transition-colors duration-80 group-[.is-active]/row:text-[var(--system-700)]",
      className
    )}
    {...props}
  />
